...
public class LobbyPlayer implements Player {
	...
	public void reset() {
		...
		// Teleport na spawn
		player.teleport(new Location(player.getWorld(), -41.5, 89.0, -40.5));
		...
		// Bar
		BarAPI.setMessage(player, ChatColor.GOLD + "" + ChatColor.BOLD + "Witaj " + player.getName() + " na Altaria Network!");
	}
